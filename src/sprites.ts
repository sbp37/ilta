...
export const SPRITES: Record<string, Sprite> = {
  ...
  // 잡몹 — 새싹 슬라임
  sprout: {
    palette: { K, G: '#5ac86e', g: '#35944a', B: K, L: '#7ae08a' },
    rows: [
      '....KK......',
      '...KLLK.KK..',
      '...KLLKLLK..',
  ...
  // 보스 — 크라켄
  kraken: {
    palette: { K, P: '#b06ad8', p: '#7a45a0', B: K },
    rows: [
      '....KKKKK...',
      '..KPPPPPPPK.',
      '.KPPPPPPPPPK',
